...
const plugin = {
  init(editor) {
    _TinyMCEActionRegistrar.default.addAction('sslink', {
      text: _i18n.default._t('AssetAdmin.LINKLABEL_FILE', 'Link to a file'),
      onAction: activeEditor => activeEditor.execCommand(commandName),
      priority: 80
    }, editor.getParam('editorIdentifier')).addCommandWithUrlTest(commandName, /^\[file_link/);
    editor.addCommand(commandName, () => {
      const field = (0, _jquery.default)(`#${editor.id}`).entwine('ss');
